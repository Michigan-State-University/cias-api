...
RSpec.describe 'POST /v1/organizations/:organization_id/interventions/:intervention_id/invitations', type: :request do
  ...
  let(:intervention) { create(:fixed_order_intervention, status: intervention_status) }
  ...
  let(:request) do
    post v1_organization_intervention_invitations_path(organization_id: organization.id, intervention_id: intervention.id),
