...
RSpec.describe 'POST /v1/live_chat/intervention/:id/navigator_setups/participant_files', type: :request do
  ...
  let(:request) do
    post v1_live_chat_intervention_navigator_setups_participant_files_path(intervention.id),
