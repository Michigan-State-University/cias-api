    ...
    describe 'instance methods' do
      describe '#create with question groups' do
        ...
        it 'creates new default question group' do
          ...
          expect(new_session.reload.question_group_plains.model_name.name).to eq 'QuestionGroup::Classic::Plain'
          expect(new_session.reload.question_group_finish.model_name.name).to eq 'QuestionGroup::Classic::Finish'
