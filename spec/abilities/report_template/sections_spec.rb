...
describe ReportTemplate::Section do
  ...
  let(:team3_report_section1) { @team3_report_section1 }
  ...
  describe 'abilities' do
    ...
    context 'team admin' do
      ...
      it 'can manage report_section of the user belonging to his team' do
        ...
        expect(subject).to have_abilities({ manage: true }, team3_report_section1)
  ...
  describe '#accessible_by' do
    ...
    context 'team1 - team_admin' do
      ...
      it 'can access only report template sections from his team' do
        expect(subject).to include(team1_report_section1, team1_report_section2, team3_report_section1).and \
