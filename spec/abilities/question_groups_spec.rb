...
describe QuestionGroup do
  ...
  let(:team1_question_group1) { @team1_question_group1 }
  let(:team1_question_group2) { @team1_question_group2 }
  let(:team2_question_group1) { @team2_question_group1 }
  let(:team2_question_group2) { @team2_question_group2 }
  let(:team3_question_group1) { @team3_question_group1 }
  ...
  describe 'abilities' do
    ...
    context 'team admin' do
      ...
      it 'can manage question_group of the user belonging to his team' do
        expect(subject).to have_abilities({ manage: true }, team1_question_group1)
        expect(subject).to have_abilities({ manage: true }, team3_question_group1)
      end

      it 'can manage his question_group' do
        expect(subject).to have_abilities({ manage: true }, team1_question_group2)
      end

      it 'can\'t manage question_group of users from another team' do
        expect(subject).to have_abilities({ manage: false }, team2_question_group1)
      end
    end
  end
  ...
  describe '#accessible_by' do
    ...
    context 'admin' do
      ...
      it 'can access all question_groups' do
        expect(subject).to include(
          team1_question_group1, team1_question_group2, team2_question_group1, team2_question_group2
        )
      end
    end
    ...
    context 'collaborator' do
      ...
      it do
        expect(subject).to include(question_group).and not_include(
          team1_question_group1, team1_question_group2, team2_question_group1, team2_question_group2
        )
      end
    end
    ...
    context 'team1 - team_admin' do
      ...
      it 'can access only question_groups from his team' do
        expect(subject).to include(team1_question_group1, team1_question_group2, team3_question_group1).and \
          not_include(team2_question_group1, team2_question_group2)
      end
    end
    ...
    context 'team2 - team_admin' do
      ...
      it 'can access only question_groups from his team' do
        expect(subject).to include(team2_question_group1, team2_question_group2).and \
          not_include(team1_question_group1, team1_question_group2)
      end
    end
    ...
    context 'team1 - researcher' do
      ...
      it 'can access only his question_group' do
        expect(subject).to include(team1_question_group1).and \
          not_include(team1_question_group2, team2_question_group1, team2_question_group2)
      end
    end
    ...
    context 'participant' do
      ...
      it 'can\'t access any of the teams question_group' do
    ...
    context 'preview_session' do
      ...
      it 'can\'t access only for questions groups of preview session created for preview user' do
        expect(subject).not_to include(team1_question_group1,
                                       team1_question_group2, team2_question_group1, team2_question_group2)
        expect(subject).not_to include(prev_question_group)
      end
    end
  end
end
