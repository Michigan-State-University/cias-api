...
describe Question do
  ...
  describe 'abilities' do
    ...
    context 'collaborator' do
      ...
      let!(:resource) { create(:question_multiple, question_group: create(:question_group, session: create(:classic_session, intervention: intervention))) }
  ...
  describe '#accessible_by' do
    ...
    context 'collaborator' do
      ...
      let(:intervention) { create(:intervention) }
      let!(:collaborator_connection) { create(:collaborator, intervention: intervention, user: collaborator, view: true) }
      let!(:question) { create(:question_multiple, question_group: create(:question_group, session: create(:classic_session, intervention: intervention))) }
      let(:user) { collaborator }
