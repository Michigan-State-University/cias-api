...
RSpec.describe 'Benchmark', type: :request do
  context 'v1/user_interventions #index' do
    ...
    let!(:user_interventions) { create_list(:user_intervention, 50, intervention: intervention, user: participant1, status: 'completed') }
    ...
    it 'gives a proper benchmark' do
      ...
      Benchmark.ips do |x|
        ...
        x.report('GET 25 User Interventions') { get v1_user_interventions_path, params: params_small, headers: admin.create_new_auth_token }
        x.report('GET 50 User Interventions') { get v1_user_interventions_path, params: params_large, headers: admin.create_new_auth_token }
