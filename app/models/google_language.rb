...
class GoogleLanguage < ApplicationRecord
  ...
  def default_google_tts_voice
    return google_tts_language.google_tts_voices.standard_voices.first if google_tts_language.present? && google_tts_language.google_tts_voices.standard_voices.any?
