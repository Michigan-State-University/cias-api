...
class Ability::HealthClinicAdmin < Ability::Base
  ...
  def health_clinic_admin
    can :read, Organization, health_systems: { health_clinics: { id: user.accepted_health_clinic_ids } }
    ...
    can :read, HealthClinic, id: user.accepted_health_clinic_ids
    ...
    can :read, ChartStatistic, health_clinic: { id: user.accepted_health_clinic_ids }
  end
end
