...
class V1::LiveChat::Intervention::NavigatorSetupsController < V1Controller
  def show
  ...
  def setup_response(data)
    V1::LiveChat::Intervention::NavigatorSetupSerializer.new(data, { include: %i[participant_links phone] })
  end
