...
class V1::HenryFord::PatientDetailsController < V1Controller
  ...
  def verify_by_code
    ...
    render json: serialized_hash(result, 'HfhsPatientDetailAnonymized')
  end

  private

  def patient_detail_params
    params.require(:hfhs_patient_data).permit(:id, :first_name, :last_name, :dob, :sex, :zip_code, :phone_number, :phone_type, :mrn, :hfhs_patient_detail_id)
  end
