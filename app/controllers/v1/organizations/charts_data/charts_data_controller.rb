...
class V1::Organizations::ChartsData::ChartsDataController < V1Controller
  ...
  def charts_data_collection
    ...
    if ENV.fetch('USE_CHART_V2_RECORDS', nil) == '1'
      data_collection = data_collection&.where&.not(user_session_id: nil)
    else
      data_collection = data_collection&.where(v2_record: false)
    end
    ...
    data_collection = data_collection&.left_joins(:chart)
