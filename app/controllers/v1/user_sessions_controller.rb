...
class V1::UserSessionsController < V1Controller
  ...
  def create
    user_session = UserSession.find_or_initialize_by(session_id: user_session_params[:session_id], user_id: current_v1_user_or_guest_user.id, health_clinic_id: user_session_params[:health_clinic_id])
