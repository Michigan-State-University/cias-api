...
class V1::VariableReferences::QuestionService < V1::VariableReferences::BaseService
  ...
  def update_direct_variable_references
    ...
    update_report_template_sections_scoped(source_session, @old_variable_name, @new_variable_name, exclude_source_session: false)
    update_sms_plan_formulas_scoped(source_session, @old_variable_name, @new_variable_name, exclude_source_session: false)
    update_question_feedback_spectrum_scoped(source_session, @old_variable_name, @new_variable_name, exclude_source_session: false)
  end
  ...
  def update_cross_session_variable_references
    ...
    update_report_template_sections_scoped(source_session, old_cross_session_pattern, new_cross_session_pattern, exclude_source_session: true)
    ...
    update_question_feedback_spectrum_scoped(source_session, old_cross_session_pattern, new_cross_session_pattern, exclude_source_session: true)
