...
[CIAS 3.0 Code of Conduct](https://github.com/Michigan-State-University/cias-api/blob/dev/CODE_OF_CONDUCT.md).
...
- [Frontend (cias-web)](https://github.com/Michigan-State-University/cias-web#readme)
- [Backend (cias-api)](https://github.com/Michigan-State-University/cias-web#readme)
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/Michigan-State-University/cias-web/issues)
that might help you. In case you have found a suitable issue and still need clarification, you can write your question
in this issue. It is also advisable to search the internet for answers first.

If you then still feel the need to ask a question and need clarification, we recommend the following:

- Open an [Issue](https://github.com/Michigan-State-University/cias-web/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  the [bug tracker](https://github.com/Michigan-State-University/cias-web/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/Michigan-State-University/cias-web/issues/new). (Since we can't be sure at this point whether it
...
- Perform a [search](https://github.com/Michigan-State-University/cias-web/issues) to see if the enhancement has already been
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/Michigan-State-University/cias-web/issues).
