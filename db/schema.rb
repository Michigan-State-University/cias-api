...
ActiveRecord::Schema.define(version: 2023_09_29_103257) do
  ...
  create_table "answers", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["user_session_id", "question_id"], name: "index_answers_on_user_session_id_and_question_id", unique: true, where: "(created_at > '2023-09-29 11:51:43'::timestamp without time zone)"
  ...
  create_table "user_interventions", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["intervention_id", "user_id"], name: "index_user_interventions_on_intervention_id_and_user_id", unique: true, where: "(created_at > '2023-09-29 12:23:42'::timestamp without time zone)"
  ...
  create_table "user_sessions", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["user_id", "session_id"], name: "index_user_sessions_on_user_id_and_session_id", where: "((created_at > '2023-09-29 12:23:42'::timestamp without time zone) AND (multiple_fill IS FALSE))"
