...
ActiveRecord::Schema.define(version: 2024_07_02_133928) do
  ...
  create_table "answers", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.index ["user_session_id", "question_id"], name: "index_answers_on_user_session_id_and_question_id", unique: true, where: "((created_at > '2023-10-25 05:30:04'::timestamp without time zone) AND (NOT ((type)::text = ANY (ARRAY['Answer::Sms'::text, 'Answer::SmsInformation'::text]))))"
  ...
  create_table "phones", force: :cascade do |t|
    ...
    t.index ["number_bidx"], name: "index_phones_on_number_bidx"
  ...
  create_table "users", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.boolean "pending_sms_answer", default: false
